        ...
        <div className="animate-marquee flex w-max gap-10 font-mono text-[11px] tracking-wider text-ink-faint">
          {Array.from({ length: 2 }).map((_, dup) => (
            <div key={dup} className="flex shrink-0 gap-10" aria-hidden={dup === 1}>
              <span className="text-signal">● LIVE, NO PAYWALL</span>
              <span>FREE OFFENSIVE SECURITY EDUCATION</span>
              <span className="text-red-blood/70">BEGINNER TO ADVANCED</span>
              <span>ACTIVE DIRECTORY ATTACK PATHS</span>
              <span>DETECTION ENGINEERING</span>
              <span className="text-red-blood/70">WRITTEN BY A WORKING PENTESTER</span>
        ...
        <div className="grid gap-10 md:grid-cols-[1.3fr_0.7fr_1.2fr]">
          <div>
            ...
            <p className="mt-4 font-mono text-[11px] leading-relaxed text-ink-faint">
              Questions about a course? Email{' '}
              <a
            ...
            {NETWORK.map((site) => (
              <li key={site.href}>
                ...
                >
                  ...
                  <span className="sr-only">— leaves academy.zephryx.in, opens in a new tab</span>
                </a>
              </li>
            ))}
          </ul>
